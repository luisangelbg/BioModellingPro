...
(function () {
  ...
  const APA = `Barrera-Guzmán, L. Á., Ramírez-Ojeda, G., Cadena-Iñiguez, J., Cadena-Zamudio, D. A., Cadena-Zamudio, J. D., &amp; Mojica-Zárate, H. T. (${YEAR}). <i>BioModelling Pro: biogeography and species distribution modelling in the browser</i> (Version 1.1.0) [Computer software]. Zenodo. https://doi.org/${DOI}`;
